...
def load_and_encode_train_data(num_queries, data_name):
    file_name_queries = f"ce_dataset/{data_name}"
    file_name_column_min_max_vals = "ce_dataset/column_min_max_vals.csv"
    ...
    samples_enc = encode_samples(tables, table2vec)
...
def get_train_datasets(num_queries, data_name):
    dicts, column_min_max_vals, min_val, max_val, labels_train, labels_test, max_num_joins, max_num_predicates, train_data, test_data = load_and_encode_train_data(num_queries, data_name)

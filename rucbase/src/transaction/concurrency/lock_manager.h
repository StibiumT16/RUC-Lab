...
public:
    ...
    std::list<LockManager::LockRequest>::iterator GetFirstWaitRqt_RECORD(const Rid &rid, int tab_fd);

    std::list<LockManager::LockRequest>::iterator GetFirstWaitRqt_TABLE(int tab_fd);

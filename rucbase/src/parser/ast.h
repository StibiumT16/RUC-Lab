...
struct SelectStmt : public TreeNode {
    std::vector<std::shared_ptr<Col>> cols, order_cols;
    ...
    SelectStmt(std::vector<std::shared_ptr<Col>> cols_,
               ...
               std::vector<std::shared_ptr<BinaryExpr>> conds_,
               std::vector<std::shared_ptr<Col>> order_cols_,
               std::vector<int> orders_,
               int top_) :
            cols(std::move(cols_)), tabs(std::move(tabs_)), conds(std::move(conds_)), order_cols(std::move(order_cols_)), orders(std::move(orders_)), top(top_) {}
};
...
struct SemValue {
    ...
    std::pair<std::pair<std::vector<std::shared_ptr<Col>>, std::vector<int> >, int> sv_order;
    std::pair<std::vector<std::shared_ptr<Col>>, std::vector<int> > sv_order_collist;
};
